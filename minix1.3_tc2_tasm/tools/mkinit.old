...
tcc -c -k- -f- -G -mt -Di8088 -I..\include init.c
if not "%1" == "" goto sep
echo Making INIT module -- combined I&D
tlink /ml /n /c ..\lib\headt init, init.exe, init.map, ..\lib\tmodel ..\lib\minix
...
rem
tlink /ml /n /c ..\lib\heads init, init.exe, init.map, ..\lib\smodel ..\lib\minix
dos2out -i init
goto done
:done
del init.obj
