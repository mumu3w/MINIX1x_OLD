...
@CODE	SEGMENT WORD PUBLIC 'CODE'	; text segment
@CODE	ENDS
@CODEB	SEGMENT BYTE PUBLIC 'CODEB'	; text segment
@CODEB	ENDS
@DATAB	SEGMENT WORD PUBLIC 'DATAB'	; data segment
@DATAB	ENDS
...
DGROUP	GROUP	@CODE,@CODEB,@DATAB,@DATAC,@DATAI,@DATAT,@DATAU,@DATAV
